...
public class Heap<T extends Comparable<T>> {
    ...
    public T peek() {
        //TODO
    	if(container.size() == 0) {
    		throw new IllegalStateException("Zero elements in Container");
    	}
    	else {
    ...
    private void heapifyUp() {
    	...
    	while(hasParent(p) && container.get(p).compareTo(container.get(getParentIndex(p))) < 0) {
